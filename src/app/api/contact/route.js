...
export async function POST(request) {
    ...
    const info = await transporter.sendMail({
      ...
      subject: `Inquiry from ObiTech Portfolio Contact Form`, 
      text: "", 
      html: `
      <!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    if(info.messageId){
      return NextResponse.json({ error:false, message:"Message successfully sent! Thank you for contacting Obi Digital" })
