          ...
          <div className="sm:flex gap-[20px] mt-[50px] max-w-[1105px] w-full h-full">
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Al Khail Gate Phase 2</p>
                </div>
                <div>
                  <p className="text-[#666666]">Al Quoz, Dubai</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Mob: +971567891964</p>
                </div>
                <div>
            ...
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">obinnayaonyinyechi@gmail.com</p>
                </div>
                <div>
                  <p className="text-[#666666]"></p>
                </div>
