    ...
    <React.Fragment>
      ...
      >
        <div className="container m-auto">
          ...
          I Love Building application with frontend and backend operation
          </h4>
          <section className="relative flex flex-col lg:flex-row px-5 md:px-24">
            ...
            >
              {" "}
              My name is Obi. I am a professional full stack
              Developer and Data Scientist. I love learning and adapting to new technologies. 
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              I have skills in HTML, CSS, Javascript, React js, Next js, Node js, Express js and MongoDB, machine learning, python programming, tabulae for data analysis and visualization, data analysis, Mysql, data cleaning, exploration using pandas,numpy, Flask and Django.
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              ...
              future. Please feel free to get in touch.
            </p>
          </section>
        </div>
      </div>
